...
class StorageAnalyzerApp(tk.Tk):
    ...
    def _build_ui(self) -> None:
        ...
        self.summary_tree.column("user", width=150, anchor="w")
        ...
        self.summary_tree.column("path", width=520, anchor="w")
        ...
        self.delete_results_tree.column("user", width=130, anchor="w")
        self.delete_results_tree.column("status", width=95, anchor="center")
        self.delete_results_tree.column("message", width=620, anchor="w")
        self.delete_results_tree.column("sid", width=230, anchor="w")
